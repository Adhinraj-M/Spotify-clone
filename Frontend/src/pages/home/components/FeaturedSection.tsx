import FeaturedGridSkelton from "@/components/skeltons/FeaturedGridSkelton";
...
const FeaturedSection = () => {
  ...
  if (isLoading) return <FeaturedGridSkelton />;
      ...
      {featuredSongs.map((song) => (
        ...
        >
          <img
            src={song.imageUrl}
            alt={song.title}
            className="w-16 sm:w-20 sm:H-20 h-20 flex-shrink-0 object-cover"
          />
