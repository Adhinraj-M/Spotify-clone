...
import { useChatStore } from "@/stores/useChatStor"
...
const isPlaying=true;
  ...
  return (
    <div className="h-full bg-zinc-900 rouned-lg flex flex-col">
        ...
        <ScrollArea className="flex-1">
            <div className="p-4 space-y-4">
                {users.map((user)=>(
                    <div key={user._id} className="cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md
                    transition-colors group">
                        <div className="flex items-start gap-3 ">
                            <div className="relative">
                                <Avatar className="size-10 border border-y-zinc-800">
                                    <AvatarImage src={user.imgageUrl}
                                    alt={user.fullName}/>
                            ...
                            <div className="flex-1 min-w-0">
                                ...
                                {isPlaying ? (
                                    <div className="mt-1">
                                        ...
                                        <div className="text-sm text-zinc-400 truncate">By Taylor Swift</div>
                                    </div>
                                ):(
    ...
    <div className="h-full flex flex-col items-center justify-center p-6 text-center space-y-4">
        <div className="relative">
         ...
         <div className="space-y-2 max-w-[250px]">
            ...
            <p className="text-sm text-zinc-400"> Login to discover what music you friends are enjoying right now</p>
         </div>
    </div>)
}